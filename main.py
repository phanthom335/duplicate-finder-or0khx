    """
    Duplicate Finder Or0khx
    =======================
    Lightweight terminal utility built to organise your filesystem and configurations.
    ...
    APP_NAME    = "Duplicate Finder Or0khx"
    APP_VERSION = "1.0.0"
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Lightweight terminal utility built to organise your filesystem and configurations.")
